  ...
  <div>
    <div class="sticky">
      <b-nav tabs>
        ...
        <b-nav-item to="/databases" active>Databases</b-nav-item>
    ...
    <b-container fluid>
      <b-row>
        ...
        <b-col cols="2">
          ...
          <br>
          <b-row>
            <b-button to="/databases/date" block="true" variant="outline-secondary" id="Date" class="testingBtn">Date</b-button>
          </b-row>
          </div>
        </b-col>
