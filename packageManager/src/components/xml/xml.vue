  ...
  <div>
    <div class="sticky">
      <b-nav tabs>
        ...
        <b-nav-item to="/xml" active>XML</b-nav-item>
      </b-nav>
    </div>
    ...
    <b-container fluid>
      <b-row>
        ...
        <b-col cols="2">
          ...
          <br>
          <b-row>
            <b-button to="/xml/issue" block="true" variant="outline-warning" id="IssueResolve" class="testingBtn">Issue Resolve Time</b-button>
          </b-row>
          <br>
          <b-row>
            <b-button to="/xml/differences" block="true" variant="outline-danger" id="Differences" class="testingBtn">Number of Differences</b-button>
          </b-row>
          <br>
           <b-row>
          ...
          <br>
          <b-row>
            <b-button to="/xml/date" block="true" variant="outline-secondary" id="Date" class="testingBtn">Date</b-button>
          </b-row>
          </div>
        </b-col>
